...
import { Users, Briefcase, CalendarDays, ShieldCheck, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-200 via-white to-blue-100 overflow-hidden">
      ...
      >
        ...
        <nav className="space-x-6 text-gray-700 font-medium hidden md:block">
          ...
          <Link to="/login" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:shadow-lg hover:scale-105 transition">Login</Link>
          <Link to="/signup" className="bg-gray-100 text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 hover:scale-105 transition">Sign Up</Link>
        </nav>
      </motion.header>
      ...
      >
        ...
        >
          <h2 className="text-5xl md:text-6xl font-extrabold text-gray-800 leading-tight mb-5 drop-shadow-sm">
            Empowering <span className="text-blue-600">Campus Placements</span> <br /> with Technology 🚀
          </h2>
          <p className="text-gray-600 mb-8 text-lg">
            Streamline your recruitment process with our all-in-one platform — built for students, recruiters, and TPOs.
          </p>
      ...
      {/* Features */}
      <section id="features" className="py-28 bg-gradient-to-r from-blue-50 to-blue-100">
        <motion.h3
        ...
        <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-12 px-10">
          ...
          {
            icon: <Briefcase size={50} className="text-blue-600 mb-4 mx-auto" />,
            title: "Company Dashboard",
            desc: "Recruiters can post openings, shortlist candidates, and view analytics.",
          },
          {
            icon: <CalendarDays size={50} className="text-blue-600 mb-4 mx-auto" />,
            title: "Drive Management",
            desc: "Plan and manage placement drives with automated scheduling tools.",
          },
          {
            icon: <ShieldCheck size={50} className="text-blue-600 mb-4 mx-auto" />,
            title: "Admin Control",
            ...
            >
              {f.icon}
              <h4 className="text-2xl font-semibold mb-3 text-gray-800">{f.title}</h4>
      ...
      {/* About */}
      <section id="about" className="py-32 px-10 text-center bg-gradient-to-b from-white to-blue-50">
        <motion.h3
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          The <span className="font-semibold text-blue-600">Smart Campus Recruitment Portal</span> bridges the gap between
          students and companies. It helps colleges manage recruitment drives with transparency, speed, and simplicity —
      ...
      <footer className="bg-gray-900 text-white py-10 text-center">
        ...
        <div className="mt-3 text-gray-400 text-xs">
          Built with ❤️ using React.js, TailwindCSS, and Framer Motion.
        </div>
      </footer>
    </div>
  );
